...

{
  ...
  "weba11y": [
    ...
    {
      "checkId": "web.touch-target",
      "target": "circle[role=slider]\"c1 length\"",
      "message": "circle[role=slider]\"c1 length\" measures 18x18px at 375px viewport; interactive targets must be >= 44px in both dimensions"
    },
    {
      "checkId": "web.touch-target",
      "target": "circle[role=slider]\"probe angle in degrees\"",
      "message": "circle[role=slider]\"probe angle in degrees\" measures 22x22px at 375px viewport; interactive targets must be >= 44px in both dimensions"
    }
  ]
}
