...
{
  "iteration": 1,
  "buildError": "npm run build exited 1:\n61:   let glow = $state(0);\n\u001b[31m✗\u001b[39m Build failed in 1.32s\n\u001b[31merror during build:\n\u001b[31m[vite-plugin-svelte:compile] [plugin vite-plugin-svelte:compile] ../sessions/dotprod/page/interactives/DotAlignment.svelte (257:6): C:/Users/jaker/Desktop/projects/harnesses/lessons/sessions/dotprod/page/interactives/DotAlignment.svelte:257:6 `{@const}` must be the immediate child of `{#snippet}`, `{#if}`, `{:else if}`, `{:else}`, `{#each}`, `{:then}`, `{:catch}`, `<svelte:fragment>`, `<svelte:boundary>` or `<Component>`\nhttps://svelte.dev/e/const_tag_invalid_placement\u001b[31m\nfile: \u001b[36mC:/Users/jaker/Desktop/projects/harnesses/lessons/sessions/dotprod/page/interactives/DotAlignment.svelte:257:6\u001b[31m\n\u001b[33m\n 255 |              <line {...{ x1: a.shaft.x1, y1: a.shaft.y1, x2: a.shaft.x2, y2: a.shaft.y2 }} class=\"shaft cand-stroke\" />\n 256 |              <polygon points={a.head} class=\"cand-fill\" />\n 257 |              {@const lp = labelPos(r.angle, r.len, 26)}\n                                                              ^\n 258 |              <text\n 259 |                x={Math.min(Math.max(lp.px, 44), S - 48)}\n\u001b[31m\n\u001b[39m"
}
