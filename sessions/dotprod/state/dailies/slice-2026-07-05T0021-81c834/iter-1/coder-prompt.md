...
- visual intent: [visual: connect-to-reality] Two columns of numbers slide in side by side, one for the listener's taste and one for the song; paired entries light up in periwinkle and a single lilac score readout counts up as the comparison lands. The question card holds over the frozen score, half the frame deliberately empty.
