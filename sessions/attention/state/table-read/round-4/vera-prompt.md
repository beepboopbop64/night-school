...
## TASK (S3 voice pass, table-read round 4, Sonnet tier)
...
On-screen text (labels/terms):
  ...
  * slope = 0
Prediction prompt (pause card): "How do you make "where to look" something a gradient can touch? Take ten seconds."
